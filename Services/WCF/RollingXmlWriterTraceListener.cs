...
namespace WM.Common.Services.WCF
{
    ...
    public class RollingXmlWriterTraceListener : XmlWriterTraceListener {
        ...
        protected bool IsRollingConditionReached {
            get {
                using (new WrapperImpersonationContext(this.dbManagerBase.ServiceLoggerDomain, this.dbManagerBase.ServiceLoggerUser, this.dbManagerBase.ServiceLoggerPassword).Context) {
        ...
        private DBManagerBase dbManagerBase {
            get;
            set;
        }
        #endregion
        ...
        /// <summary>
        /// Catches unhandled exceptions EX: from unmanaged code.
        /// </summary>
